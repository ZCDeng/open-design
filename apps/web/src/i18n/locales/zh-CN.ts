...
export const zhCN: Dict = {
  ...
  'settings.onboardingAmrBody': "Open Design 官方 Model Router 平台。\n支持主流模型，并享有 Token 价格优惠。\n一个 API 完成全部配置，后续支持多模态模型、Skill 和 Connector。",
  'settings.onboardingAmrAction': "继续使用 AMR Cloud",
  'settings.onboardingAmrWaitingTitle': "等待 AMR 登录 / 注册",
  'settings.onboardingAmrWaitingBody': "我们已经打开一个模拟的 AMR 登录窗口。当前 mock 会在约 5 秒后自动验证通过，并继续设置。",
  'settings.onboardingAmrOpenAgain': "重新打开 AMR",
